  ...
  const nearbyGyms = [
    {
      ...
      price: 150,
      monthlyPrice: 2500,
      tags: ["Powerlifting", "24/7", "AC"],
      amenities: ["Shower", "Locker", "WiFi", "Parking"],
    ...
    },
    {
      ...
      price: 100,
      monthlyPrice: 1800,
      tags: ["Cardio", "Classes", "Yoga"],
      amenities: ["Shower", "Locker", "AC"],
      coordinates: [14.58, 121.09],
    ...
    },
    {
      ...
      price: 200,
      monthlyPrice: 3500,
      tags: ["CrossFit", "Olympic", "Pro"],
      amenities: ["Shower", "Locker", "WiFi", "Parking", "Sauna"],
      coordinates: [14.572, 121.092],
    ...
    },
    {
      ...
      monthlyPrice: 2200,
      tags: ["Weights", "Cardio"],
      amenities: ["Shower", "Locker", "AC", "WiFi"],
      coordinates: [14.568, 121.088],
    ...
    },
    {
      ...
      price: 180,
      monthlyPrice: 3000,
      tags: ["MMA", "Boxing", "Weights"],
      amenities: ["Shower", "Locker", "WiFi", "Parking", "AC"],
      coordinates: [14.571, 121.084],
      ...
      hours: "6:00 AM - 10:00 PM",
      totalEquipment: 38,
      type: "Combat Sports & Fitness",
      deal: "Free Week Trial",
    },
  ];
  ...
  const promos = [
    {
      ...
      desc: "Valid at IronForge & PowerHouse Pro",
      cta: "Grab Deal",
    ...
    },
    {
      ...
      desc: "Every Saturday & Sunday this month",
      cta: "Learn More",
    ...
    },
    {
      id: 3,
      badge: "MEMBERS ONLY",
      title: "10% Off Monthly Plans",
      desc: "Use code GYMFIND at checkout",
      cta: "Claim Now",
  ...
  useEffect(() => {
    ...
    async function loadMe() {
      ...
      try {
        ...
        console.log("[Home] /me failed:", err?.response?.status);
      } finally {
    ...
    const markers = filteredGyms.map((gym) => {
      ...
      const icon = L.divIcon({
        ...
        html:
          '<div class="gm-pin' +
          (isHot ? " gm-pin--hot" : "") +
          '"><div class="gm-pin__bubble"><span>&#8369;' +
          gym.price +
          "</span>" +
          (isHot ? '<span class="gm-pin__dot"></span>' : "") +
          '</div><div class="gm-pin__tip"></div></div>',
        iconSize: [72, 44],
        iconAnchor: [36, 44],
      });
          ...
          <div className="uhv-profile-wrap" ref={profileRef}>
            ...
            >
              <div className="uhv-profile-avatar">
                ...
                />
                <span className="uhv-profile-avatar__fallback">{String(displayName || "U").trim().charAt(0).toUpperCase()}</span>
              </div>
        ...
        <div className="uhv-hero__inner">
          <div className="uhv-hero__left">
            ...
            <p className="uhv-hero__sub">
              {nearbyGyms.length} gyms in Pasig · {nearbyGyms.filter((g) => g.openNow).length} open now
            </p>
            <div className="uhv-hero__stats">
              <div className="uhv-hstat">
                <strong>{userStats.gymsVisited}</strong>
                <span>Explored</span>
              </div>
              ...
              <div className="uhv-hstat-div" />
              <div className="uhv-hstat">
                <strong>{userStats.thisWeek}</strong>
                <span>This Week</span>
              </div>
              <div className="uhv-hstat-div" />
              <div className="uhv-hstat">
                <strong>{userStats.streak}d</strong>
                <span>Streak</span>
              </div>
            </div>
          </div>
          ...
          <div className="uhv-hero__right">
            <div className="uhv-goal">
              ...
              <div className="uhv-goal__track">
                <div className="uhv-goal__fill" style={{ width: progressPct + "%" }} />
              </div>
              <p className="uhv-goal__note">
                {progressPct >= 100
                  ? "Goal complete!"
                  : weeklyGoal.target - weeklyGoal.done + " more session" + (weeklyGoal.target - weeklyGoal.done !== 1 ? "s" : "") + " to go"}
              </p>
            </div>
      ...
      <div className="uhv-body">
        <div className="uhv-toolbar">
          ...
          <div className="uhv-sort">
            ...
            {[
              ...
              <button key={v} className={"uhv-sort-btn" + (sortBy === v ? " active" : "")} onClick={() => setSortBy(v)}>
                {l}
              </button>
            ))}
          </div>
                  ...
                  .map((gym) => (
                    <Link key={gym.id} to={"/home/gyms/" + gym.id} className="uhv-pick">
                      ...
                      <div className="uhv-pick__info">
                        ...
                        <p className="uhv-pick__meta">
                          <Navigation size={10} /> {gym.distance}km &nbsp;·&nbsp; <Star size={10} fill="#f59e0b" color="#f59e0b" /> {gym.rating}
                        </p>
                      </div>
                  ...
                  return (
                    <div key={a.id} className="uhv-activity__item">
                      ...
                      <div className="uhv-activity__body">
                        <Link to={"/home/gyms/" + a.gymId} className="uhv-activity__gym">
                          {a.gym}
                        </Link>
                ...
                {filteredGyms.map((gym) => (
                  <div key={gym.id} id={"gym-card-" + gym.id} className="uhv-card">
                    ...
                    <div className="uhv-card__content">
                      <div className="uhv-card__top-row">
                        <div className="uhv-card__title-block">
                          ...
                          <p className="uhv-card__loc">
                            <MapPin size={11} /> {gym.location} &nbsp;·&nbsp; <span className="uhv-card__type-label">{gym.type}</span>
                          </p>
                        </div>
                      ...
                      <div className="uhv-card__tags">{gym.tags.map((t, i) => <span key={i} className="uhv-card__tag">{t}</span>)}</div>
        ...
        <section className="uhv-section">
          <div className="uhv-section__hdr">
            ...
            <Link to="/home/events" className="uhv-section__link">
            ...
            {upcomingEvents.map((ev) => (
              <Link key={ev.id} to={"/home/gyms/" + ev.gymId} className="uhv-event-card">
                <div className="uhv-event-card__date" style={{ background: ev.color + "15", borderColor: ev.color + "30" }}>
                  <span className="uhv-event-card__day-name" style={{ color: ev.color }}>
                    {ev.day}
                  </span>
                ...
                <div className="uhv-event-card__body">
                  ...
                  <p className="uhv-event-card__gym">
                    <MapPin size={10} /> {ev.gym}
                  </p>
                  <p className="uhv-event-card__meta">
                    <Clock size={10} /> {ev.time} &nbsp;·&nbsp; <Users size={10} /> {ev.spots} spots left
                  </p>
                </div>
                <div className="uhv-event-card__cta" style={{ background: ev.color }}>
                  Join
                </div>
              </Link>
            ))}
        ...
        <section className="uhv-section">
          <div className="uhv-section__hdr">
            ...
            <Link to="/home/reviews" className="uhv-section__link">
          ...
          <div className="uhv-reviews">
            {topReviews.map((r) => (
              <div key={r.id} className="uhv-review-card">
                ...
                <Link to={"/home/gyms/" + r.gymId} className="uhv-review-card__gym">
        ...
        <section className="uhv-section">
          <div className="uhv-section__hdr">
            ...
            <Link to="/home/help" className="uhv-section__link">
              Help center <ChevronRight size={14} />
            </Link>
          </div>
        ...
        <section className="uhv-cta-banner">
          <div className="uhv-cta-banner__inner">
            ...
            <Link to="/home/referral" className="uhv-cta-banner__btn">
              Get My Link <ArrowRight size={14} />
            </Link>
          </div>
        </section>
          ...
          <div className="uhv-support-grid">
            <a href="mailto:support@exersearch.ph" className="uhv-support-card">
              ...
              <div>
                ...
                <p className="uhv-support-card__val">support@exersearch.ph</p>
              </div>
            </a>
            <a href="tel:+639000000000" className="uhv-support-card">
              ...
              <div>
                ...
                <p className="uhv-support-card__val">+63 900 000 0000</p>
              </div>
            </a>
            ...
            <div className="uhv-support-card uhv-support-card--social">
              ...
              <div className="uhv-social-row">
                <a href="#" className="uhv-social-btn uhv-social-btn--ig">
                  <Instagram size={16} />
                </a>
                <a href="#" className="uhv-social-btn uhv-social-btn--fb">
                  <Facebook size={16} />
                </a>
        ...
        <div className="uhv-overlay" onClick={() => setShowFilterModal(false)}>
          <div className="uhv-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="uhv-modal__ftr">
              <button className="uhv-modal-reset" onClick={() => { setPriceRange([0, 500]); setSelectedAmenities([]); }}>
                Reset
              </button>
