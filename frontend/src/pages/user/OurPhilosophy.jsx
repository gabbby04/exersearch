...
/* ─── DATA ─── */
const panels = [
  { front: "/philo1.png", right: "/philo5.png", back: "/philo1.png", left: "/philo5.png" },
  { front: "/philo2.png", right: "/philo4.png", back: "/philo2.png", left: "/philo4.png" },
  { front: "/philo3.png", right: "/philo3.png", back: "/philo3.png", left: "/philo3.png" },
  { front: "/philo4.png", right: "/philo2.png", back: "/philo4.png", left: "/philo2.png" },
  { front: "/philo5.png", right: "/philo1.png", back: "/philo5.png", left: "/philo1.png" },
];
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.from(".philoPanel", {
        y: 36, opacity: 0, rotateY: 16,
        stagger: 0.08, duration: 1.15, ease: "power3.out",
      });
      gsap.from(".philoPanel__face img", {
        scale: 1.08, stagger: 0.04, duration: 1.8, ease: "power3.out",
      });
      gsap.from(".philoHero__content", {
        y: 28, opacity: 0, duration: 1.1, delay: 0.2, ease: "power3.out",
      });
      ...
      const onTouch = () => {
        if (tappedRef.current) { tappedRef.current = false; tl.reverse(); }
        else                   { tappedRef.current = true;  tl.play();    }
      };
        ...
        <section className="philoHero">
          <div className="philoHero__hero" ref={heroRef}>
            <div className="philoHero__panels">
              {panels.map((panel, i) => (
                <div className={`philoPanel philoPanel--${i + 1}`} key={i}>
                  <div className="philoPanel__cuboid">
                    <div className="philoPanel__face philoPanel__face--front"><img src={panel.front} alt="" /></div>
                    <div className="philoPanel__face philoPanel__face--right"><img src={panel.right} alt="" /></div>
                    <div className="philoPanel__face philoPanel__face--back"> <img src={panel.back}  alt="" /></div>
                    <div className="philoPanel__face philoPanel__face--left"> <img src={panel.left}  alt="" /></div>
                  </div>
                </div>
              ))}
            </div>
        ...
        <section className="ph-principles">
          <div className="fq-wrap">
            <div className="ph-principles__hdr">
              <span className="ph-eyebrow">Our Principles</span>
              <h2 className="ph-principles__title">
                We make fitness feel more <em>understandable</em>,<br />
                more supportive, and more real.
              </h2>
        ...
        <section className="philoUsersAlt">
          <div className="fq-wrap">
            <div className="philoUsersAlt__head">
              <span className="philoUsersAlt__eyebrow">For Users</span>
        ...
        <section className="ph-owners">
          <div className="fq-wrap">
            <div className="ph-owners__hdr">
              <span className="ph-owners__eyebrow">For Owners</span>
              <h2 className="ph-owners__title">
                We give fitness businesses more <em>visibility</em><br />
