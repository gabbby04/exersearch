...
export default function Chatbot() {
    ...
    setMessages([
      {
        role: "assistant",
        content:
          "Hi! I'm ExerBot, your AI fitness assistant. I can help you find gyms, create workout plans, and plan your meals. What would you like to know?",
  ...
  const clearConversation = async () => {
    ...
    try {
      const token = getTokenMaybe?.() || localStorage.getItem("auth_token") || localStorage.getItem("token");

      if (token) {
        await api.delete("/api/v1/chat/clear");
      }
